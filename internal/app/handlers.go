...
func setMapsHandler(c *gin.Context) {
	...
	rulesAndMapsCopy := []string{
		...
		"**Bo1 Format:**",
		"Use the https://aoe2cm.net/preset/flNAd Pick & Ban tool.",
		"For each game, start by picking three factions. Of your three only one can be the following factions: Slaanesh, Warriors of Chaos, Vampire Coast, and Vampire Counts",
		"For the swiss rounds, please pre-declare your faction picks in the “sft declaration channel” on Turin's discord. This saves everyone time.  For example:",
		"R1-3: Pick SL, HE, and GS",
		"You can also vary your bans by round/map if you like.  Here's a second example:",
		"R1: Pick SL, HE, and GS",
		"R2: Pick WoC, DW, and SK",
		"R3: Pick SL, WE, and KI",
		"With both players' 3-factions selected in hand, you will proceed to list the 9 potential matchups and sequentially ban 8 of them (in a 1-2-2-2-1 pattern).  It works like this:",
		"1. One player can type out and number all nine matchups.  For example if one player picked SL-DW-GS and the other picked WoC-HE-GC, these are all the potential matchups you would type out:",
		"    1. SL-WoC; 2. SL-HE; 3. SL-GC; 4. DW-WoC; 5. DW-HE; 6. DW-GC; 7-GS-WoC; 8. GS-HE; 9. GS-GC.",
		"2. Then players take turns banning matchups in a 1-2-2-2-1 pattern.  The remaining lone matchup is played.",
