...
2. Set up a way to schedule leaderboard updates either on each match change or periodically
3. Set up some admin functionality for fixing oops and such
4. Add event support
5. Add help command
6. Add command shortcut aliases like /q /dq /r
