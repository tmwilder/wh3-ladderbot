...
3. Set up a way to communicate the map pool to a channel
4. Set up a way to pull and communicate the leaderboard back to a channel
...
9. Ping the players when they are paid